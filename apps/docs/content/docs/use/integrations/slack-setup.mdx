...
<Callout type="info" title="Where to verify">
  Go to **Plugins** and click your Slack instance. The instance detail page shows recent inbound and
  outbound events. This is the first place to check when something is not working.
</Callout>
