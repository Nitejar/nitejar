...
4. Open **Activity** in Nitejar. You should see the work item with a full receipt trail: webhook received, work item created, run dispatched, inference calls, response delivered.
