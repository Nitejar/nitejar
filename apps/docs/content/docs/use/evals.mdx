...
<Callout type="info" title="Where to verify">
  Open an agent detail page and use its eval assignment section to see available templates. Each
  template lists its criteria and weights before you assign it.
</Callout>
...
<Callout type="info" title="Where to verify">
  Open an agent detail page to see all assigned evaluators, their gate/scorer status, weights, and
  sample rates. You can add, edit, or remove assignments from that panel.
</Callout>
...
<Callout type="info" title="Where to verify">
  Open an agent detail page for the agent's eval summary, score trend chart, and per-evaluator
  breakdown. Click any eval run to see the full pipeline result, individual criterion scores, and
...
<Callout type="info" title="Where to verify">
  Open an agent detail page to see total eval cost alongside the eval summary. Individual eval runs
  show per-result cost breakdowns.
</Callout>
