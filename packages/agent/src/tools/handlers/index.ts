...
export const toolHandlers: Record<string, ToolHandler> = {
  ...
  list_plugin_instances: listPluginInstancesTool,
  get_plugin_instance: getPluginInstanceTool,
  set_plugin_instance_agent_assignment: setPluginInstanceAgentAssignmentTool,
