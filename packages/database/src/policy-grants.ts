...
export const POLICY_GRANT_CATALOG: PolicyGrantDescriptor[] = [
  ...
  },
  {
    ...
    resourceType: 'run',
    resourceLabel: 'Runs',
    resourceHint: 'Fleet execution history — inspect runs, traces, messages, and costs',
    operationId: 'read',
    operationLabel: 'read',
    uiSection: 'fleet',
    enforcementOwner: 'agent/fleet-observability',
  },
  {
    action: 'fleet.work.read',
    resourceType: 'work_item',
    resourceLabel: 'Work Items',
    resourceHint: 'Fleet work receipts — inspect work items, dispatches, queue state, and triage',
    operationId: 'read',
    operationLabel: 'read',
    uiSection: 'fleet',
    enforcementOwner: 'agent/fleet-observability',
  },
  {
    ...
    resourceLabel: 'Plugin Instances',
    resourceHint: 'Connection instances — inspect assignments, configs, and delivery wiring',
    operationId: 'read',
    operationLabel: 'read',
    uiSection: 'plugins',
    enforcementOwner: 'agent/platform-control',
  ...
  },
  {
    ...
    resourceType: '*',
    resourceLabel: 'Evals',
    resourceHint: 'Evaluation runs, rubrics, assignments, and score trends',
    operationId: 'read',
    operationLabel: 'read',
    uiSection: 'evals',
    enforcementOwner: 'agent/eval-tools',
  },
  {
    action: 'eval.write',
    resourceType: '*',
  ...
  {
    action: 'eval.settings.write',
    resourceType: '*',
    resourceLabel: 'Eval Settings',
    resourceHint: 'Global defaults for the eval pipeline',
    operationId: 'write',
    operationLabel: 'write',
    uiSection: 'evals',
    enforcementOwner: 'agent/eval-tools',
  ...
  },
  {
    ...
    operationLabel: 'policy read',
    uiSection: 'github',
    enforcementOwner: 'agent/github-policy',
  },
  {
    action: 'github.repo.policy.write',
    resourceType: '*',
    resourceLabel: 'GitHub',
    resourceHint: 'Repository operations — code access, branches, PRs, and reviews',
    operationId: 'policy-write',
    operationLabel: 'policy write',
    uiSection: 'github',
    enforcementOwner: 'agent/github-policy',
  },
  {
